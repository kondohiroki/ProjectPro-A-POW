    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2" id="sidePanLeft">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a href="SubPro.php"><button class="btn" id="editButtFollow" style="background-color: #00254d">My Subscribe</button></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-container">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                    <button type="button" class="btn btn-outline-primary" id="buttEdit">Edit</button>
                                </div>
                                </div>
                            </div>
                        </div>
