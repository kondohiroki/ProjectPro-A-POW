...
<div class="container-fluid">
                <center><div class="row" id="MiddleChangePass" >
                        <div class="col-lg-2" id="sidePanLeft">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="ChangePasswordPage.html"><button class="btn" id="editButtFollow" style="background-color: #00254d">Change Password</button></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a href="MyCard.html"><button class="btn" id="editButtFollow">My Card</button></a>
                                </div>
                            </div>
                        </div>
