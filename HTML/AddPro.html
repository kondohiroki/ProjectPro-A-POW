...
<body>
  ...
  Promotion Name:&emsp;<br><input type="text" class ="form-control" name="Promotionname" maxlength="2" id="Promotext" width="2%" required><!-- Promotion Name -->
<br>

Category:&emsp;<select> <!-- Category Selecter -->
  <option value="Food">Food</option>
  <option value="Dessert">Dessert</option>
  <option value="Travel">Travel</option>
  <option value="Discount">Discount</option>
</select><br><br>Description: <br><!-- Description -->
<textarea class ="form-control" cols="40" rows="5" name="Describe"> 
</textarea><br>
<div class="col-sm-6">
...
<action="/action_page.php" method="get">
 <input type="checkbox" name="Cardtype" value="VISA">&nbsp;VISA&emsp;&emsp;<input type="checkbox" name="Cardtype" value="American Express">&nbsp;American Express&emsp;&emsp;<input type="checkbox" name="Cardtype" value="JCB" >&nbsp;JCB&emsp;&emsp;<br>
 <input type="checkbox" name="Cardtype" value="Master Card" >&nbsp;Master Card&emsp;&emsp;<input type="checkbox" name="Cardtype" value="UnionPay">UnionPay
</div>
<br>
