      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="card" style="width:600px">
              <h1> Detail </h1>
              <img class="card-img-top" src="../IMG/5.jpg"height="100%"  alt="Card image">
                <div class="card-body">
                    <h4 class="card-title">ว้าว ว้าว ว้าว...สายเซลล์อย่าพลาด ช็อปสินค้าแบรนด์ดัง กับงาน Fashion Island “Fashion Surprise Sale” ลดสูงสุด 70% (วันนี้ - ยังไม่มีกำหนด)</h4>
                      <p class="card-text">ว้าว ว้าว ว้าว...สายเซลล์อย่าพลาด ช็อปสินค้าแบรนด์ดัง กับงาน Fashion Island “Fashion Surprise Sale” ลดสูงสุด 70% (วันนี้ - ยังไม่มีกำหนด)
                            ว้าว ว้าว ว้าว...สายเซลล์อย่าพลาด ช็อปสินค้าแบรนด์ดังลดถึง 70%<br>
                            ลดขนาดนี้ร้องว้าวให้พอแล้วรีบมาช็อปกัน<br>
                            ที่งาน Fashion Surprise Sale ชั้น 1
                            ศูนย์การค้า แฟชั่นไอส์แลนด์ รามอินทรา<br>
                            ตั้งแต่วันที่ 10 - 17 ตุลาคม 2560<br>
                            *ตรวจสอบเงื่อนไข ณ จุดขาย<br>
                      </p>
