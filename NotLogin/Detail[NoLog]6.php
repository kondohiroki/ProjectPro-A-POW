      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="card" style="width:600px">
              <h1> Detail </h1>
              <img class="card-img-top" src="../IMG/6.jpg"height="100%"  alt="Card image">
                <div class="card-body">
                    <h4 class="card-title">กลับมาอีกครั้ง! แมคข้าวพะแนง อร่อยจัดจ้านถึงใจ เริ่มเพียงจานละ 59 บาท (วันนี้ - ยังไม่มีกำหนด)</h4>
                      <p class="card-text">กลับมาอีกครั้ง! แมคข้าวพะแนง อร่อยจัดจ้านถึงใจ เริ่มเพียงจานละ 59 บาท (วันนี้ - ยังไม่มีกำหนด)<br>
                          กลับมาอีกครั้ง! แมคข้าวพะแนง<br>
                          อร่อยจัดจ้านถึงใจ เริ่มเพียงจานละ 59 บาท<br>
                          หรือจะเลือกอร่อยกับข้าวขี้เมา ก็ฟินสุด!!<br>
                          เริ่ม 17 พ.ย. - 28 ธ.ค.​ 60 (หรือจนกว่าสินค้าจะหมด)<br>
                          สาขาที่ร่วมรายการ bitly.com/mcstores_promotion<br>
                      </p>
