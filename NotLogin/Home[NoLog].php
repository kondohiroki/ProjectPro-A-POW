            ...
            echo "<div class='col-lg-12'>";
              echo "<div class='card' style='width:600px'>";
                ...
                echo "<div class='card-body'>";
                  ...
                  echo "<a href='Pro10004[NoLog].php'><button type='button' class='btn btn-outline-primary' id='buttProLeft'>Details</button></a>";
        ...
        echo '<div class="row">';
            echo '<div class="col-lg-12">';
              echo '<div class="card" style="width:600px">';
                echo '<img class="card-img-top" src="data:image/jpeg;base64,'.base64_encode($pro_img).'"/>';
                echo '<div class="card-body">';
                  echo "<a href='Pro10005[NoLog].php'><h4 class='card-title'>".$pro_name."</h4></a>";
                  echo '<a href="Pro10005[NoLog].php"><button type="button" class="btn btn-outline-primary" id="buttProLeft">Details</button></a>';
                  echo '<a href="#"><button type="button" class="btn btn-outline-danger" id="buttProRight">Subscribe</button></a>';
                echo '</div>';
              echo '</div>';
            echo '</div>';
            ...
            echo '<div class="col-lg-12">';
              echo '<div class="card" style="width:600px">';
                ...
                echo '<div class="card-body">';
                  ...
                  echo '<a href="Pro10006[NoLog].php"><button type="button" class="btn btn-outline-primary" id="buttProLeft">Details</button></a>';
                  echo '<a href="#"><button type="button" class="btn btn-outline-danger" id="buttProRight">Subscribe</button></a>';
                echo '</div>';
              echo '</div>';
            echo '</div>';
        ...
        echo '<div class="row">';
            echo '<div class="col-lg-12">';
              echo '<div class="card" style="width:600px">';
                echo '<img class="card-img-top" src="data:image/jpeg;base64,'.base64_encode($pro_img).'"/>';
                echo '<div class="card-body">';
                  echo "<a href='Pro10007[NoLog].php'><h4 class='card-title'>".$pro_name."</h4></a>";
                  echo '<a href="Pro10007[NoLog].php"><button type="button" class="btn btn-outline-primary" id="buttProLeft">Details</button></a>';
                  echo '<a href="#"><button type="button" class="btn btn-outline-danger" id="buttProRight">Subscribe</button></a>';
                echo '</div>';
              echo '</div>';
            echo '</div>';
        ...
        echo '<div class="row">';
            echo '<div class="col-lg-12">';
              echo '<div class="card" style="width:600px">';
                echo '<img class="card-img-top" src="data:image/jpeg;base64,'.base64_encode($pro_img).'"/>';
                echo '<div class="card-body">';
                  echo "<a href='Pro10003[NoLog].php'><h4 class='card-title'>".$pro_name."</h4></a>";
                  echo '<a href="Pro10003[NoLog].php"><button type="button" class="btn btn-outline-primary" id="buttProLeft">Details</button></a>';
                  echo '<a href="#"><button type="button" class="btn btn-outline-danger" id="buttProRight">Subscribe</button></a>';
                echo '</div>';
              echo '</div>';
            echo '</div>';
