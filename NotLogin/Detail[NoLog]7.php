      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="card" style="width:600px">
              <h1> Detail </h1>
              <img class="card-img-top" src="../IMG/7.jpg"height="100%"  alt="Card image">
                <div class="card-body">
                    <h4 class="card-title">ผู้ถือบัตร Central card เมื่อซื้อบัตรโดยสารของ Thaiairways ได้รับเงินคืนสูงสุด 5,500บาท..(1 ต.ค.60-30 พ.ย.60)</h4>
                      <p class="card-text">ผู้ถือบัตร Central card เมื่อซื้อบัตรโดยสารของ Thaiairways ได้รับเงินคืนสูงสุด 5,500บาท<br>
                        รับเครดิตเงินคืน 5,500 เมื่อซื้อบัตรโดยสารตั้งแต่ 120,000 ขึ้นไป /เซลล์สลิป<br>
                        รับเครดิตเงินคืน 1,200 เมื่อซื้อบัตรโดยสารตั้งแต่ 50,000 ขึ้นไป /เซลล์สลิป<br>
                        รับเครดิตเงินคืน 200 เมื่อซื้อบัตรโดยสารตั้งแต่ 15,000 ขึ้นไป /เซลล์สลิป<br>
                        จำกัดเครดิตเงินสูงสุด 5,500 บาท/หมายเลขบัญชีบัตรหลัก ตลอดรายการ<br>
                        เริ่ม 1 ต.ค. 60  - 30 พ.ย. 60<br>
                      </p>
