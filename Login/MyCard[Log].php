                      ...
                      <div class="row">
                        <div class="col-sm-10">
                          <div class="card" id="CardPan">
                            <p>Phanurut Kondo&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;VISA</p>
                            <p>xxxx-xxxx-xxxx-x832</p>
                            <p>02/20</p>
                          </div>
                        </div>
                      </div>
                      <a href="AddCard2[Log].php"><button type="button" class="btn btn-outline-light" id="buttonCard">+</button></a>&ensp;&ensp;<small>Add New Credit Card/Debit Card</small>
                    </div>
                </div>
            </div>
          </div>
